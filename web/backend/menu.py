...
MENU_CONF = {
    ...
    '探索': {
        ...
        'level': 2,
        'list': [
            {'name': '榜单推荐', 'level': 2, 'page': 'ranking', 'icon': 'align-box-bottom-center'},
            {'name': '豆瓣电影', 'level': 2, 'page': 'douban_movie', 'icon': 'movie'},
            {'name': '豆瓣电视剧', 'level': 2, 'page': 'douban_tv', 'icon': 'device-tv'},
            {'name': 'TMDB电影', 'level': 2, 'page': 'tmdb_movie', 'icon': 'movie'},
            {'name': 'TMDB电视剧', 'level': 2, 'page': 'tmdb_tv', 'icon': 'device-tv'},
            {'name': 'BANGUMI', 'level': 2, 'page': 'bangumi', 'icon': 'device-tv-old'}
        ]
    },
    '资源搜索': {
        'name': '资源搜索',
    ...
    '站点管理': {
        ...
        'level': 2,
        'list': [
            {'name': '站点维护', 'level': 2, 'page': 'site', 'icon': 'server-2'},
            {'name': '数据统计', 'level': 2, 'page': 'statistics', 'icon': 'chart-pie'},
            {'name': '刷流任务', 'level': 2, 'page': 'brushtask', 'icon': 'checklist'},
            {'name': '站点资源', 'level': 2, 'page': 'sitelist', 'icon': 'cloud-computing'}
        ]
    },
    '订阅管理': {
        'name': '订阅管理',
        ...
        'list': [
            ...
            {'name': '电视剧订阅', 'level': 2, 'page': 'tv_rss', 'icon': 'device-tv'},
            {'name': '自定义订阅', 'level': 2, 'page': 'user_rss', 'icon': 'file-rss'},
    ...
    '下载管理': {
        ...
        'list': [
            ...
            {'name': '自动删种', 'level': 2, 'page': 'torrent_remove', 'icon': 'download-off'}
        ]
    },
    '媒体整理': {
        'name': '媒体整理',
        'level': 1,
        'list': [
            {'name': '文件管理', 'level': 1, 'page': 'mediafile', 'icon': 'file-pencil'},
            {'name': '手动识别', 'level': 1, 'page': 'unidentification', 'icon': 'accessible'},
            {'name': '历史记录', 'level': 1, 'page': 'history', 'icon': 'history'},
            {'name': 'TMDB缓存', 'level': 1, 'page': 'tmdbcache', 'icon': 'brand-headlessui'}
        ]
    },
    '服务': {
        'name': '服务',
    ...
    '系统设置': {
        ...
        'list': [
            ...
            {'name': '媒体库', 'level': 1, 'page': 'library', 'icon': 'stereo-glasses'},
            ...
            {'name': '自定义识别词', 'level': 1, 'page': 'customwords', 'icon': 'a-b'},
            {'name': '索引器', 'level': 2, 'page': 'indexer', 'icon': 'list-search'},
            {'name': '下载器', 'level': 2, 'page': 'downloader', 'icon': 'download'},
            {'name': '媒体服务器', 'level': 2, 'page': 'mediaserver', 'icon': 'server-cog'},
            {'name': '插件', 'level': 1, 'page': 'plugin', 'icon': 'brand-codesandbox'}
        ]
    }
}
...
# 服务配置
SERVICE_CONF = {
    'rssdownload': {'name': '电影/电视剧订阅', 'svg': 'cloud-download', 'color': 'blue', 'level': 2},
    ...
    'nametest': {'name': '名称识别测试', 'time': '', 'state': 'OFF', 'svg': 'alphabet-greek', 'color': 'lime', 'level': 1},
    'ruletest': {'name': '过滤规则测试', 'time': '', 'state': 'OFF', 'svg': 'adjustments-horizontal', 'color': 'yellow', 'level': 2},
    ...
    'processes': {'name': '系统进程', 'time': '', 'state': 'OFF', 'svg': 'terminal-2', 'color': 'muted', 'level': 1}
}
